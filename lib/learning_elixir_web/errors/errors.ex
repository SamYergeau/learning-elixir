defmodule LearningElixirWeb.Errors do
  alias Ecto.Changeset
  alias LearningElixirWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(LearningElixir.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(LearningElixir.Gettext, "errors", message, options)
    end
  end
